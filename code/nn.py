...
class myMLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out, n_hiddenLayers, activation=T.tanh):
...
def train_nn(train_model, validate_model, test_model,
            n_train_batches, n_valid_batches, n_test_batches, n_epochs, l_r, learning_rate, adapt,
            verbose = True):
    """
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in range(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if adapt and (best_validation_loss-this_validation_loss)*100 < 0.2:
